...
char bit='1';
int j=0; 
int i=0; //for(j=0;j<pow(2,varc);j++) 
for(i=0;i<varc;i++)
{
for (j=0;j<t;j++)
{
...
break; 
	//EX-NOR
case '^':
if(op1=='0' && op2=='0') insert('1');//
else if(op1=='1' && op2=='1') insert('1'); //
else if(op1=='0' && op2=='1') insert('0'); //
else if(op1=='1' && op2=='0') insert('0');// 
break;
	//AND
case '*':
	...
	for(i=0;i<=6;i++)
{
	...
	system("cls"); 
	system("color 2f");
	printf("\n\nThis Software is made by Hardik Dhamija, Dharampreet,Kartikeya  ...");
	printf("\n\n\t\tUnder the guidance of Aashish"); 
	printf("\n\nLOADING ");
for(i=0;i<=6;i++)
...
printf("...Use the following Operators...\n");
